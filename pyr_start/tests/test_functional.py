...
import unittest
import webtest
from .test_views import SQLALCHEMY_URL
...
class FunctionalTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        from pyr_start.models import (
            User,
            Page,
            get_tm_session,
        )
        from pyr_start import main
        ...
        with transaction.manager:
            ...
            page2.creator = basic
            cls.dbsession.add_all([basic, editor, page1, page2])
